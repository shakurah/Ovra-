...
def prepare_with_boe_context(user_message, top_k=3):
    ...
    system_prompt = (
        ...
        "sector cultural y creativo en España. Antes de responder, recupera y verifica fuentes "
        "oficiales (BOE, DOUE, ministerios). No especules: si la información es insuficiente, "
        "responde: \"Lo siento, con la información proporcionada no puedo ofrecer una respuesta precisa. "
        "Por favor, proporcione los datos o contexto faltantes.\" Responde en español, con párrafos "
        "breves y profesionales. Cita Ley/Artículo/Fecha/URL cuando proceda. No muestres procesos internos "
        "ni cadenas de pensamiento. Al final incluya: \"Fiabilidad estimada: [XX %]\"."
    )
